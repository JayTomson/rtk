...
*Изначально я писал это приложение через нейронки на Flutter, но так как появилась возможность в AI Studio делать андроид приложение, решил переписать его под Котлин. Вроде как норм вышло, мне даже больше нравится, чем на Flutter, но если хотите попробовать приложение на Flutter, держите ссылку: [Flutter-версия в Telegram](https://t.me/novelSSSp/65)*
